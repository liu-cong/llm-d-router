...
func (p *ctxObservingPlugin) PrepareRequestData(ctx context.Context, _ *schedulingtypes.LLMRequest, _ []schedulingtypes.Endpoint) error {
	defer p.wg.Done()
	select {
